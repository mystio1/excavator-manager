...
INSERT INTO "new_Bill" ("bankAccountId", "billDate", "billNumber", "billType", "businessId", "buyerGstin", "cgst", "createdAt", "customerId", "discount", "extraCharges", "fuelCharges", "gstPercentage", "id", "igst", "letterhead", "notes", "paidAmount", "sgst", "status", "subtotal", "totalAmount", "transportCharges", "updatedAt") SELECT "bankAccountId", "billDate", "billNumber", "billType", "businessId", "buyerGstin", "cgst", "createdAt", "customerId", "discount", "extraCharges", "fuelCharges", "gstPercentage", "id", "igst", "letterhead", "notes", "paidAmount", "sgst", "status", "subtotal", "totalAmount", "transportCharges", "updatedAt" FROM "Bill";
DROP TABLE "Bill";
