-- AlterTable
ALTER TABLE "OperatorWorkRequest" ADD COLUMN "dieselDate" DATETIME;
ALTER TABLE "OperatorWorkRequest" ADD COLUMN "dieselLiters" REAL;
ALTER TABLE "OperatorWorkRequest" ADD COLUMN "notes" TEXT;
ALTER TABLE "OperatorWorkRequest" ADD COLUMN "siteName" TEXT;

-- AlterTable
ALTER TABLE "WorkSession" ADD COLUMN "dieselDate" DATETIME;
ALTER TABLE "WorkSession" ADD COLUMN "dieselLiters" REAL;
...
INSERT INTO "new_Excavator" ("brand", "businessId", "createdAt", "currentHourMeter", "currentOperatorId", "id", "isArchived", "machineNumber", "model", "name", "purchaseDate", "serviceIntervalHrs", "startingHourMeter", "status", "updatedAt") SELECT "brand", "businessId", "createdAt", "currentHourMeter", "currentOperatorId", "id", "isArchived", "machineNumber", "model", "name", "purchaseDate", "serviceIntervalHrs", "startingHourMeter", "status", "updatedAt" FROM "Excavator";
